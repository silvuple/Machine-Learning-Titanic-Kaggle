...
select_features = ['Pclass', 'Sex', 'Relative_age', 'Relative_fare']
...
print("train_test_split svc score is ", svc.score(X_test, y_test), '\n')
print("cross_val accuracy svc score is ", cross_val_score(svc, X, y, cv=10, scoring='accuracy').mean(), '\n')
